...
QuickDictForICC 是 [InkCanvasForClass](https://github.com/InkCanvasForClass/community)（ICC-CE）的英语单词查询插件，支持 ECDICT 离线词典与用户自行导入的 MDict 词典，并内置 Edge TTS 与 Piper 本地 TTS 发音功能。
